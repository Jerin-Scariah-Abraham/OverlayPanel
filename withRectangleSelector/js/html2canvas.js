...
_html2canvas.Util.Bounds = function getBounds (el) {
  ...
  if (el.getBoundingClientRect){
    ...
    //console.log("HEre"+bounds.top+" - "+bounds.bottom+" - "+bounds.left)
    ...
    //bounds.height = 1000;
	//console.log("Here"+bounds.top+" - "+bounds.bottom+" - "+bounds.left+" - "+ bounds.width+" - "+ bounds.height);
...
_html2canvas.Parse = function (images, options) {
  ...
  function documentWidth () {
  	//console.log(doc.body.scrollWidth+" : "+ doc.documentElement.scrollWidth);
    return Math.max(
  ...
  function documentHeight () {
  	//console.log(doc.body.scrollHeight+" : "+ doc.documentElement.scrollHeight);
    return Math.max(
...
_html2canvas.Renderer.Canvas = function(options) {
  ...
  return function(zStack, options, doc, queue, _html2canvas) {
    ...
    console.log(canvas.width + " | "+canvas.height +" => " +options.elements[0]);
